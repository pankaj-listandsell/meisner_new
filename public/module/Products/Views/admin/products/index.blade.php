...
@section('content')
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if(!empty($rows))
                    <form method="post" action="{{route('products.admin.bulkEdit')}}"
            ...
            <div class="col-left">
                <form method="get" action="{{route('products.admin.index')}} " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <button class="btn-info btn btn-icon btn_search" type="submit">{{__('Search Products')}}</button>
                </form>
            </div>
        </div>
