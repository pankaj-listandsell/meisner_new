        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('birthday', $dataUser->dob ? getDateFormatAsLocale($dataUser->dob) :'') }}" name="dob" placeholder="{{__("Birthday")}}" class="form-control date-picker">
                ...
                <div class="form-group">
                    ...
                    <div class="upload-btn-wrapper">
                        <div class="input-group">
                            ...
                            <input type="text" data-error="{{__("Error upload...")}}" data-loading="{{__("Loading...")}}" class="form-control text-view" readonly
                                   value=""
                            />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select name="country" class="form-control">
                        ...
                        @foreach(get_country_lists() as $name)
                            <option @if((old('country',$dataUser->country ?? '')) == $name) selected @endif value="{{$name}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
