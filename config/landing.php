...
return [
    ...
    'list_demo'=>[
        [
            'url'=>'https://sandbox.ges.org',
            'name'=>'Homepage',
            'thumb'=>'img/demo/home.png',
        ],
        [
            'url'=>'https://sandbox.ges.org/tour',
            'name'=>'Tour Search',
            'thumb'=>'img/demo/tour.png'
        ],
        [
            'url'=>'https://sandbox.ges.org/tour/paris-vacation-travel',
            'name'=>'Single Tour',
            'thumb'=>'img/demo/tour_single.png'
        ],
        [
            'url'=>'https://sandbox.ges.org/en/page/space',
            'name'=>'Home Space',
            'thumb'=>'img/demo/home-space.png',
        ],
        [
            'url'=>'https://sandbox.ges.org/en/space',
            'name'=>'Space Search',
            'thumb'=>'img/demo/space-search.png'
        ],
        [
            'url'=>'https://sandbox.ges.org/en/space/stay-greenwich-village',
            'name'=>'Single Space',
            'thumb'=>'img/demo/single-space.png'
        ],
        [
            'url'=>'https://sandbox.ges.org/tour?_layout=map',
            'name'=>'Search Map',
            'thumb'=>'img/demo/tour_map.png',
            'class'=>'col-lg-8 col-md-12 col-sm-12'
        ],
        [
            'url'=>'https://sandbox.ges.org/news',
            'name'=>'Blog List',
            'thumb'=>'img/demo/news.png'
        ],
//        [
//            'url'=>'https://sandbox.ges.org/contact',
//            'name'=>'Contact Page',
