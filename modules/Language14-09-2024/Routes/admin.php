...
Route::group(['prefix'=>'translations'],function (){
    ...
    Route::get('loadTranslateJson',[TranslationsController::class, 'loadTranslateJson'])->name('language.admin.translations.loadTranslateJson');
    Route::get('loadStrings',[TranslationsController::class, 'loadStrings'])->name('language.admin.translations,loadStrings');
