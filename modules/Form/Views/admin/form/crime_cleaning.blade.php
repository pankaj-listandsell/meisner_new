...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Crime Cleaning Form")}}</h1>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
                <form method="get" action="{{route('admin.form.crime_cleaning')}} "
        ...
        <div class="clearfix">
            <div class="pull-left">
                <a href="{{ route('admin.form.crime_cleaning') }}">@lang('All') ({{ $countAll }})</a> |
                <a href="{{ route('admin.form.crime_cleaning', ['read' => 0]) }}">@lang('Unread') ({{ $countUnread }})</a>
            </div>
