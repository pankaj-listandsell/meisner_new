...
class News extends BaseModel
{
    ...
    {
        return url(config('news.news_frontend_route_prefix')."/".$this->slug);
    }*/
    ...
    {
        $meta['seo_title'] = __("Blogs"); //setting_item_with_lang("news_page_list_seo_title", false,null) ?? setting_item_with_lang("news_page_list_title",false, null) ?? __("Blogs")
