    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                <a href="{{route('news.admin.create')}}" class="btn btn-primary">{{__("Add new blog")}}</a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
                <form method="get" action="{{route('news.admin.index')}} " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <button class="btn-info btn btn-icon btn_search" type="submit">{{__('Search Blogs')}}</button>
                </form>
            </div>
        </div>
