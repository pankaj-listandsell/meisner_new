...
<head>
    ...
    <title>AFLEX Dienstleistungen</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<div class="content">
    <div style="width: 100%;height: 104px;padding-top: 25px;background-color: #fff;border-bottom: 2px dotted #e8e8e8;">
        <div style="width: 100%;margin: 0 auto;text-align: center;">
            <img style="width: 35%;" src="https://aflex.de/uploads/0000/1/2023/10/09/aflex-png-logo.png" alt="aflex-logo">
        </div>
    </div>
    <div style="width: 550px; background-color: #FFFFFF; padding:30px 25px 50px; margin-bottom: 0px;color:#000000">
        ...
        <hr>
        <div style="text-align:center">AFLEX Dienstleistungen<br><span style="color:#000000!important">Romain-Rolland-Straße 55</span><br>13089
            Berlin<br><br>Telefon: 030 / 2393 1002<br><a href="mailto:info@aflex.berlin" style="color: #000000;">
                info@aflex.de</a><br></div>
    </div>
</div>
</body>
