<div id="form_manager" class="form-manager-container">
    <form_manager
            :schema="{{ json_encode(\App\Libraries\FormSchema\Form\CrimeCleaningForm::schema()) }}"
            :config="{{ json_encode([
                        'lang' => get_current_lang(),
                        'registerFormUrl' => route('frontend.register.crime_cleaning_form'),
...
@push('js')
    ...
    <script src="{{ asset('dist/frontend/js/crime_cleaning_form.js') }}"></script>
@endpush
