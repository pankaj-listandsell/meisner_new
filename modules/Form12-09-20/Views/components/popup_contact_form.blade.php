<div class="popup-contact-form">
    ...
    <div class="contact-desc">
        @lang("Would you like advice over the phone? Leave your phone number! We'll call you")
    </div>
    ...
    <div class="popup-form-elements">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    placeholder="{{ trans('Enter telephone no') }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="form-group">
            <label>
                ...
                <span>{{ trans("I have read and agree to the terms of use and Privacy Policy") }}</span>
            </label>
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn popup-form-btn">@lang('Submit')</button>
    </div>
</div>
