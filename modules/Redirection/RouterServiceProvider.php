...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Redirection\Controllers';

    protected $adminModuleNamespace = 'Modules\Redirection\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix(config('admin.admin_route_prefix').'/module/redirection')
