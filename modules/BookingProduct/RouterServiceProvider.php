...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\BookingProduct\Controllers';

    protected $adminModuleNamespace = 'Modules\BookingProduct\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix(config('admin.admin_route_prefix').'/module/bookingproduct')
