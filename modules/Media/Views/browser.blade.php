            ...
            <div id="cdn-browser" class="cdn-browser d-flex flex-column" v-cloak :class="{is_loading:isLoading}">
                ...
                <div class="files-list">
                    ...
                    <div class="border-top border-left mb-3 px-3" v-if="viewType == 'list'">
                        ...
                        <file-item v-for="(file,index) in files" :key="index" :view-type="viewType" :selected="selected" :file="file" v-on:select-file="selectFile" @dblclick.native="handleImageDblClick(file)"></file-item>
                    </div>
