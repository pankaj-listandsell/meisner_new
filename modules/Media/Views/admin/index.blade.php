...
@section('content')
    ...
    @dblclick.native="handleImageDblClick(file)">
</file-item>
                    </div>
    ...
    @dblclick.native="handleImageDblClick(file)">
                ...
                <div class="browser-actions d-flex justify-content-between flex-shrink-0" v-if="selected.length">
                    <div class="col-left" v-show="selected.length">
                        ...
                        <div style="display: none;" class="control-remove" v-if="selected && selected.length">
                            <button class="btn btn-primary" @click="generateThumbnails">{{__("Generate Thumbnail")}}</button>
                            <button class="btn btn-warning" @click="deleteThumbnails">{{__("Delete Thumbnail")}}</button>
                        </div>
            ...
            <!-- Modal Structure -->
            <div class="modal show" id="mediaModal" tabindex="-1" role="dialog" aria-labelledby="mediaModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="mediaModalLabel">Edit Media Details</h5>
