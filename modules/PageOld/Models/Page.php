...
class Page extends BaseModel implements Editable
{
    use EditableTrait;
    ...
    {
        $pages = $this->getPagesWithLanguage();
    ...
    {
        return route('page.admin.store_ajax', ['id' => $this->getKeyValue(), 'lang' => get_current_lang()]);
    }
    ...
    {
        $pages = parent::query()->published()->get();
