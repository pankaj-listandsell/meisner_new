...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? config('app.name')}}</title>
    ...
    @if(true)
        ...
        <link href="{{ asset('dist/admin/css/form.min.css') }}" rel="stylesheet"/>
    ...
    <!-- custom css -->
    <link href="{{ asset('custom/css/new_custom.css') }}" rel="stylesheet">
    <link href="{{ asset('dist/admin/css/custom_admin.css?version='.rand(1,10000)) }}" rel="stylesheet">
    <script>
        var bookingCore  = {
            url:'{{url('/')}}',
            ...
            bts_datepicker_format: '{{ getDateFormatOfBtDatePicker() }}',
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; <a href="{{__('https://listandsell.de/')}}" target="_blank">   {{__('List&Sell')}}</a>
                    </div>
                </div>
            </div>
        </footer>
