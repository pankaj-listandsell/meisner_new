<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        ...
        <i class="input-icon icon-inbox"></i>
    ...
    @if(is_enable_registration())
        <div class="c-grey font-medium f14 text-center"> {{__('Do not have an account?')}} <a href="#register" data-target="#register" data-toggle="modal">{{__('Sign Up')}}</a></div>
    @endif
</form>
