        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{route('products.admin.category.store',['id'=>-1])}}" method="post">
                            @csrf
                            @include('Products::admin/category/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('products.admin.category.bulkEdit')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('products.admin.category.index')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            @csrf
                            ...
                            <table class="table table-hover">
                                ...
                                @if(count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{route('products.admin.category.edit',['id'=>$row->id])}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
                                        <td>{{$row->slug}}</td>
