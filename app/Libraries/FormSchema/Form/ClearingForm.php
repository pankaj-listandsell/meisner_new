...
class ClearingForm
{
    public static function schema(): array
    {
        return [
            ...
            [
                ...
                'options' => [
                    [
                        'name' => trans('Apartment Liquidation'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/appartment.png'
                    ],
                    [
                        'name' => trans('Clearing Out / Disposal'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/garbage-car.png'
                    ],
                    [
                        'name' => trans('Cellar Liquidation'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/basement.png'
                    ],
                    [
                        'name' => trans('Company Liquidation'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/office-building.png'
                    ],
                    [
                        'name' => trans('Renovation'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/renovation.png'
                    ]
                ],
                'default' => [],
                'required' => true,
            ...
            [
                'name' => 'order_living_space',
                'label' => trans('Living space (m²)'),
                'options' => null,
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::number->name,
                'placeholder' => trans('Living space (m²)'),
                'validation' => ['required'],
            ],
            [
                'name' => 'order_total_rooms',
                'label' => trans('Number of rooms'),
                'options' => null,
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::number->name,
                'placeholder' => trans('Number of rooms'),
                'validation' => ['required'],
            ],
            [
                'name' => 'order_evacuation_site',
                'label' => trans('Evacuation site'),
                'options' => [
                    trans('Complete apartment'),
                    trans('Halfway through the apartment'),
                    trans('In some cases, up to 10 pieces of furniture'),
                    trans('Some furniture, up to 5 pieces of furniture'),
                    trans('A piece of furniture')
                ],
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::select->name,
            ...
            [
                'name' => 'order_has_basement',
                'label' => trans('Has basement'),
                ...
                'placeholder' => '',
                'related' => 'service',
                'linked' => [trans('Apartment Liquidation'), trans('Clearing Out / Disposal')],
                'validation' => ['required'],
            ],
            [
                'name' => 'order_has_more_storage',
                'label' => trans('Has more storage'),
                'options' => [trans('Yes'), trans('No')],
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::radio->name,
                'placeholder' => '',
                'related' => 'service',
                'linked' => [trans('Cellar Liquidation'), trans('Company Liquidation'), trans('Renovation')],
                'validation' => ['required'],
            ],
            [
                'name' => 'order_floor',
                'label' => trans('Floor'),
                'options' => ['1.OG', '2.OG', '3.OG', '4.OG', '5.OG', '6.OG', '7.OG', '8.OG', '9.OG', '10.OG', '11.OG', '12.OG', '13.OG', '14.OG', '15.OG', '16.OG', '17.OG', '18.OG', '19.OG'],
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::select->name,
                'placeholder' => trans('Please select'),
            ...
            [
                'name' => 'work_detail',
                'label' => trans('Work detail'),
                'options' => '',
                'default' => '',
                'required' => true,
                'type' => FormEntryTypes::textarea->name,
                'placeholder' => trans('What should be cleared out?'),
                'validation' => ['required'],
            ],
            [
                'name' => 'attachment',
                ...
                'default' => '',
                'required' => false,
                'type' => FormEntryTypes::image->name,
                'acceptable' => [],
                'placeholder' => '',
                'validation' => ['nullable', 'mimes:jpg,jpeg,png,pdf'],
            ],
            [
                'name' => 'extra_service',
                'label' => trans('Extra service'),
                'options' => [
                    [
                        'name' => trans('Apartment Liquidation'),
                        'image' => 'https://aflex.berlin/wp-content/uploads/2023/05/appartment.png'
            ...
            [
                ...
                'placeholder' => trans('I have read and agree to the terms of use and Privacy policy'),
                'validation' => ['required'],
            ],
        ];
    }
    ...
    public static function validationMessages(): array
    {
        return [
            ...
            "service.array" => trans('Service is invalid'),
            ...
            "attachment.mimes" => trans('Attachment PDF/Image must be type jpg or pdf'),
