...
<head>
    <meta charset="UTF-8"/>
    <title>GES - Ultimate Booking System</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://www.facebook.com/greenelephantsanctuarypark/" target="_blank">Support</a>
                    ...
                    <ul class="menu">
                        ...
                        <li><a target="_blank" href="https://www.facebook.com/greenelephantsanctuarypark/">Support</a></li>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>GES</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
        <a target="_blank"  href="{{config('landing.item_url')}}" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
                <li><a target="_blank" href="https://www.facebook.com/greenelephantsanctuarypark/"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
