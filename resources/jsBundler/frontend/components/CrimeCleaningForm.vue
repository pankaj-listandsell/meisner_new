<template>
    <div>
        <template v-if="showForm">
                ...
                <section v-show="form.step === 2">
                    ...
                    <div class="form-step-second">
                        ...
                        <div class="step-second-title clearfix">
                            <strong class="float-left">{{ trans('Crime scene cleaning by') }}:</strong>
                        </div>

                        <div class="form-group-inner">
                            <label>
                                {{ trans('Place of Order') }}:
                                <span class="sym-required">*</span>
                            </label>
                            <div class="form-group">
            ...
            <transition name="slide-fade">
                <section v-show="form.step === 3">
                    ...
                    <div class="form-step-third" :key="generateRandomId()">
        ...
        <template v-else>
            <div id="form_6399a0db34" class="thank-you-message">
